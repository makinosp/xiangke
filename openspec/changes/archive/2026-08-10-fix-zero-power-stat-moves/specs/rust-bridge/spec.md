...
Extends the GDExtension bridge to handle the new `stat_mod_target` field and
stat modification effects for non-damaging moves.

## MODIFIED Requirements

### Requirement: Data conversion

The system SHALL convert GDScript Dictionaries to Rust types via
dict_to_character/dict_to_move and serialize Rust types back via
participant_to_dict/result_to_dict.
