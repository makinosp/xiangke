# Move Selection UI Specification
...
- **WHEN** the player selects the switch option
- **THEN** the bench character selection is opened

#### Scenario: Cancel returns to move list

- **WHEN** the player cancels the bench character selection
- **THEN** the move list for the active character is shown again
